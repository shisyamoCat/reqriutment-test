...
export default class App extends React.Component {
    constructor(props){
        ...
        // RESAS-API 総人口rul
        const url_pop = `https://opendata.resas-portal.go.jp/api/v1/population/composition/perYear?cityCode=-&prefCode=${prefId + 1}`;
    }
    ...
    componentDidMount() {
        ...
        fetch(url_pref, { headers: { "X-API-KEY": this.apiKey } })
        .then(res => res.json())
        .then(data => {
